...
Component({
  ...
  lifetimes: {
    attached() {
      ...
      this.setData({
        hueColor: hsv2rgb((rgb2hsv(initColor)).h, 100, 100)
      })
    },
    ready() {
  ...
  methods: {
    ...
    changeHue: function (e) {
      ...
      this.setData({
        ...
        colorRes: hsv2rgb(hue, this.data.hsv.s, this.data.hsv.v)
      });
      this.onEnd();
    },
    changeSV: function (e) {
      ...
      this.setData({
        "hsv.s": x,
        "hsv.v": y,
        colorRes: hsv2rgb(this.data.hsv.h, x, y)
      });
      this.onEnd();
    },
